...
import { getAddressPosts } from '../../actions/postAddress';
...
//use for desending and acending
//////////////////////////////////////////////////////////////////////
...
//Title and Rows
function createData(addressId, userId, userName, address, city, state, createdAt) {
  return { addressId, userId, userName, address, city, state, createdAt };
}

//Rows to use
const rows = [
  createData('35235235235235', "213154124", "Abel", "515 lagoon ter", "Evanston", 'IL', "Tuesday"),
